...
[Narrative post](https://experiment.com/u/Hd2AYg#:~:text=4.%20Researchers%20spent%20a%20variable%20amount%20of%20time%20after%20claiming%20an%20issue%20until%20their%20first%20result%2C%20with%20a%20median%20of%2012%20days)
...
- **Claim timing reflects metadata, not intent.** For explicitly claimed experiments, the claim date is when the `Claimed By::` block was created in Roam. The `Claimed By::` attribute was introduced to the lab in October 2023. For inferred claims (no `Claimed By::` field), the claim date is the first experimental log entry, which may post-date when the researcher actually began thinking about the problem.
...
- [Result page: EVD 6](https://roamresearch.com/#/app/discourse-graphs/page/Iyef0kkul)
