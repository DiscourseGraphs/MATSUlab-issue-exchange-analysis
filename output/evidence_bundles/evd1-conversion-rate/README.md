...
- **Claiming detection is metadata-dependent.** Claiming was assessed via the `Claimed By::` page attribute, page authorship, or authorship of dated log entries within experiment pages. Issues that were informally transferred between researchers — without updating the metadata — are not captured. The `Claimed By::` attribute was introduced to the lab in October 2023.
