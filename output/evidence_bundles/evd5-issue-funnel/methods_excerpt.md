...
This excerpt contains the methods sections relevant to the issue-to-experiment-to-result conversion funnel analysis. See `data/funnel_summary.json` and `data/experiment_details.csv` for current counts.
